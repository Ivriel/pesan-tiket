                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('routes.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="departure" name="departure" type="text" class="mt-1 block w-full" :value="old('departure')" required autofocus />
                        ...
                        <div>
                            ...
                            <x-text-input id="arrival" name="arrival" type="text" class="mt-1 block w-full" :value="old('arrival')" required autofocus />
