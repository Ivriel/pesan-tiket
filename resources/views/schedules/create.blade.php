                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('schedules.store') }}" enctype="multipart/form-data"
                        ...
                        <div>
                            ...
                            <input type="datetime-local" id="date_departure" name="date_departure" value="{{ old('date_departure') }}"
                            autofocus
                        ...
                        <div>
                            ...
                            <input type="datetime-local" id="date_arrival" name="date_arrival" value="{{ old('date_arrival') }}"
                                class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                            @error('date_arrival')
                                <p class="mt-2 text-red-500">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="flex items-center gap-4">
                            <x-primary-button>{{ __('Buat Jadwal') }}</x-primary-button>
