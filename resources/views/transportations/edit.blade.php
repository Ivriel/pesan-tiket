                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('transportations.store') }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name',$transportation->name)" required autofocus />
                        ...
                        <div>
                            ...
                            <x-text-input id="code" name="code" type="text" class="mt-1 block w-full" :value="old('code',$transportation->code)" required autofocus />
                            <x-input-error class="mt-2 text-red-500" :messages="$errors->get('code')" />
                        </div>

                         <div>
                            <x-input-label for="total_seat" :value="__('total_seat')" />
                            <x-text-input id="total_seat" name="total_seat" type="number" class="mt-1 block w-full" :value="old('total_seat',$transportation->total_seat)" required autofocus />
